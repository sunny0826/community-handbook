...
{{< alert icon="📌" context="success" text="在接触一个新的开源社区时，请先仔细阅读其行为准则，这是了解社区的一个重要指标。如果你正在帮助社区制定一份行为准则，请务必要和项目组成员强调行为准则的重要性，以及如何使用行为准则来维护社区的健康。" />}}

> 内容来自 [Contributor Covenant](https://www.contributor-covenant.org/)，其是一个被超过 40,000 个开源项目（包括 Kubernetes, Rails 和 Swift）所使用的行为准则。

<!-- > 运营 Tips 📌：在接触一个新的开源社区时，请先仔细阅读其行为准则，这是了解社区的一个重要指标。如果你正在帮助社区制定一份行为准则，请务必要和项目组成员强调行为准则的重要性，以及如何使用行为准则来维护社区的健康。 -->
...
<!-- [上一页 (社区原则)](./1-2-principles.md) | [下一页 (开源社区的基础架构)](../chapter2/README.md) -->
